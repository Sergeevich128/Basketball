...
const ChangeMatch:FC<Props> = ({changePrev, changeNext}) => {
  ...
  return (
    <div className="changeMatch">
      <div className="buttonPrev">
        <svg onClick={() => changePrev()} width="14" height="21" viewBox="0 0 14 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="buttonNext">
        <span >Next</span>
        <svg onClick={() => changeNext()} width="14" height="21" viewBox="0 0 14 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
