...
import {ISelectedBet} from "../../betSlipReducer";
import {changeInputStake} from "../../actions";
import {connect} from "react-redux";
import {changeValueOfSelectedField} from "../../../../bets/actions";
...
const SelectedBet: FC<Props> = ({selectedBet, removeBet, changeInputStake, changeValueOfSelectedField}) => {
            ...
            <div className="selected-bet">
                ...
                <div>
                    <div>
                        ...
                        />
                        <div onClick={handleSelectedBet} className="remove-selected-bet"/>
                    </div>
